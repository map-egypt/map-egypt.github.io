          ...
          <nav className='page__prime-nav'>
            <div className='nav-block' id='nav-block-browse'>
              ...
              <ul className='utilities-menu'>
                <li><Link to='/projects' title='Visit projects and indicators page' className='browse-menu__item link--deco' activeClassName='link--deco-active'><span>English</span></Link></li>
                <li><Link to='/about' title='Visit about page' className='browse-menu__item link--deco' activeClassName='browse-menu__item'><span>Arabic</span></Link></li>
